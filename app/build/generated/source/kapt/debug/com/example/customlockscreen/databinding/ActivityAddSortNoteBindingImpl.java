...
public class ActivityAddSortNoteBindingImpl extends ActivityAddSortNoteBinding  {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeAddSortNoteCard((com.example.customlockscreen.databinding.SortNoteAttributeLayoutBinding) object, fieldId);
        }
        return false;
    }
    private boolean onChangeAddSortNoteCard(com.example.customlockscreen.databinding.SortNoteAttributeLayoutBinding AddSortNoteCard, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
