...
public class SortNoteAttributeLayoutBindingImpl extends SortNoteAttributeLayoutBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewmodelchild == variableId) {
            setViewmodelchild((com.example.customlockscreen.viewmodel.SortNoteViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewmodelchild(@Nullable com.example.customlockscreen.viewmodel.SortNoteViewModel Viewmodelchild) {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeViewmodelchildSortNote((androidx.lifecycle.MutableLiveData<com.example.customlockscreen.model.bean.SortNote>) object, fieldId);
        }
        return false;
    }
    private boolean onChangeViewmodelchildSortNote(androidx.lifecycle.MutableLiveData<com.example.customlockscreen.model.bean.SortNote> ViewmodelchildSortNote, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    protected void executeBindings() {
        ...
        androidx.lifecycle.MutableLiveData<com.example.customlockscreen.model.bean.SortNote> viewmodelchildSortNote = null;
        com.example.customlockscreen.viewmodel.SortNoteViewModel viewmodelchild = mViewmodelchild;
        java.lang.String viewmodelchildSortNoteName = null;
        com.example.customlockscreen.model.bean.SortNote viewmodelchildSortNoteGetValue = null;
