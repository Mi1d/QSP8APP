...
public class CardItemLinearBindingImpl extends CardItemLinearBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.label == variableId) {
            setLabel((com.example.customlockscreen.model.bean.Label) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setLabel(@Nullable com.example.customlockscreen.model.bean.Label Label) {
        this.mLabel = Label;
        synchronized(this) {
            mDirtyFlags |= 0x1L;
        }
    ...
    protected void executeBindings() {
        ...
        com.example.customlockscreen.model.bean.Label label = mLabel;
        long LabelDay1 = 0;
