...
public class ActivityDetailBindingImpl extends ActivityDetailBinding  {
    ...
    static {
        ...
        sIncludes.setIncludes(0, 
            ...
            new int[] {1},
            new int[] {com.example.customlockscreen.R.layout.card_item_grid});
    ...
    private ActivityDetailBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1
            , (com.example.customlockscreen.databinding.CardItemGridBinding) bindings[1]
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeDetailCard((com.example.customlockscreen.databinding.CardItemGridBinding) object, fieldId);
        }
        return false;
    }
    private boolean onChangeDetailCard(com.example.customlockscreen.databinding.CardItemGridBinding DetailCard, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
