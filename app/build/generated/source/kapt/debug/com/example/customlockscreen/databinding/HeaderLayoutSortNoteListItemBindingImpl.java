...
public class HeaderLayoutSortNoteListItemBindingImpl extends HeaderLayoutSortNoteListItemBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.sortnote == variableId) {
            setSortnote((com.example.customlockscreen.model.bean.SortNote) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setSortnote(@Nullable com.example.customlockscreen.model.bean.SortNote Sortnote) {
    ...
    protected void executeBindings() {
        ...
        com.example.customlockscreen.model.bean.SortNote sortnote = mSortnote;
