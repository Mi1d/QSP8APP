    ...
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      protected RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        ...
        if (! _infoLABELTABLE.equals(_existingLABELTABLE)) {
          return new RoomOpenHelper.ValidationResult(false, "LABEL_TABLE(com.example.customlockscreen.model.bean.Label).\n"
                  + " Expected:\n" + _infoLABELTABLE + "\n"
                  + " Found:\n" + _existingLABELTABLE);
        }
        ...
        if (! _infoSORTNOTETABLE.equals(_existingSORTNOTETABLE)) {
          return new RoomOpenHelper.ValidationResult(false, "SORT_NOTE_TABLE(com.example.customlockscreen.model.bean.SortNote).\n"
                  + " Expected:\n" + _infoSORTNOTETABLE + "\n"
