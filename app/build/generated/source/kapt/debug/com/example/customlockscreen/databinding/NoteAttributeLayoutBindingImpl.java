...
public class NoteAttributeLayoutBindingImpl extends NoteAttributeLayoutBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewmodelchild == variableId) {
            setViewmodelchild((com.example.customlockscreen.viewmodel.LabelViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewmodelchild(@Nullable com.example.customlockscreen.viewmodel.LabelViewModel Viewmodelchild) {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeViewmodelchildLabel((androidx.lifecycle.MutableLiveData<com.example.customlockscreen.model.bean.Label>) object, fieldId);
        }
        return false;
    }
    private boolean onChangeViewmodelchildLabel(androidx.lifecycle.MutableLiveData<com.example.customlockscreen.model.bean.Label> ViewmodelchildLabel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    protected void executeBindings() {
        ...
        com.example.customlockscreen.model.bean.Label viewmodelchildLabelGetValue = null;
        boolean viewmodelchildLabelEnd = false;
        boolean viewmodelchildLabelTop = false;
        com.example.customlockscreen.viewmodel.LabelViewModel viewmodelchild = mViewmodelchild;
        androidx.lifecycle.MutableLiveData<com.example.customlockscreen.model.bean.Label> viewmodelchildLabel = null;
