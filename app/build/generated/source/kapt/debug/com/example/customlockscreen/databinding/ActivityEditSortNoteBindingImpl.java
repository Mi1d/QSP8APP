...
public class ActivityEditSortNoteBindingImpl extends ActivityEditSortNoteBinding  {
    ...
    static {
        ...
        sIncludes.setIncludes(0, 
            ...
            new int[] {1},
            new int[] {com.example.customlockscreen.R.layout.sort_note_attribute_layout});
    ...
    private ActivityEditSortNoteBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1
            ...
            , (com.example.customlockscreen.databinding.SortNoteAttributeLayoutBinding) bindings[1]
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeEditSortNoteCard((com.example.customlockscreen.databinding.SortNoteAttributeLayoutBinding) object, fieldId);
        }
        return false;
    }
    private boolean onChangeEditSortNoteCard(com.example.customlockscreen.databinding.SortNoteAttributeLayoutBinding EditSortNoteCard, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
