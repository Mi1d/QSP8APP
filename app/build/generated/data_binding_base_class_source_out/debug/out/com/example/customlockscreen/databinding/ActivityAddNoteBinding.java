...
public abstract class ActivityAddNoteBinding extends ViewDataBinding {
  ...
  @NonNull
  public final Toolbar addNoteToolbar;
  ...
  protected ActivityAddNoteBinding(Object _bindingComponent, View _root, int _localFieldCount,
      Button addNoteSure, Toolbar addNoteToolbar, NoteAttributeLayoutBinding noteAttributeLayout) {
    super(_bindingComponent, _root, _localFieldCount);
    this.addNoteSure = addNoteSure;
    this.addNoteToolbar = addNoteToolbar;
